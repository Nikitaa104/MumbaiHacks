  ...
  return (
    ...
    >
      ...
      <div className="absolute bottom-10 flex w-full flex-col items-center">
        ...
        {/* box content */}
        <div className="relative z-10 flex h-[150px] w-full items-center justify-center overflow-hidden rounded-lg border bg-background shadow-md text-white">
          {/* Badges */}
          ...
          {/* Circles */}
          <motion.div
            className="absolute -bottom-14 h-[100px] w-[100px] rounded-full bborder-t border-[#00E676] bg-accent/5"
            animate={{
          ...
          />
          <motion.div
            className="absolute -bottom-20 h-[145px] w-[145px] rounded-full border-t border-[#00E676] bg-accent/5"
            animate={{
          ...
          />
          <motion.div
            className="absolute -bottom-[100px] h-[190px] w-[190px] rounded-full border-t border-[#00E676] bg-accent/5"
            animate={{
          ...
          />
          <motion.div
            className="absolute -bottom-[120px] h-[235px] w-[235px] rounded-full border-t border-[#00E676] bg-accent/5"
            animate={{

...
const CustomControls = ({ onLocate, onToggleLayer, layers }) => {
  ...
  useEffect(() => {
    ...
    control.onAdd = () => {
      ...
      div.innerHTML = `
        <div style="background: #121212; padding: 10px; border-radius: 5px; box-shadow: 0 2px 10px rgba(0,230,118,0.2); border: 1px solid #1F1F1F;">
          <button id="locate-btn" style="margin: 2px; padding: 8px; border: none; border-radius: 3px; cursor: pointer; background: #00E676; color: #000000; font-weight: 600;">📍 Locate Me</button>
          <button id="satellite-btn" style="margin: 2px; padding: 8px; border: 1px solid #1F1F1F; border-radius: 3px; cursor: pointer; background: #0F0F0F; color: #F2F2F2;">🛰️ Satellite</button>
        </div>
      `;
...
const SearchControl = ({ onSearch }) => {
  ...
  useEffect(() => {
    ...
    control.onAdd = () => {
      ...
      div.innerHTML = `
        <div style="background: #121212; padding: 10px; border-radius: 5px; box-shadow: 0 2px 10px rgba(0,230,118,0.2); display: flex; gap: 5px; border: 1px solid #1F1F1F;">
          <input 
            id="search-input" 
            type="text" 
            placeholder="Search places..." 
            style="padding: 8px; border: 1px solid #1F1F1F; border-radius: 3px; width: 200px; background: #0F0F0F; color: #F2F2F2;"
          />
          <button 
            id="search-btn" 
            style="padding: 8px 12px; border: none; border-radius: 3px; cursor: pointer; background: #00E676; color: #000000; font-weight: 600;"
          >
            🔍
          </button>
        </div>
